...
Route::middleware('auth')->group(function () {
    ...
    Route::get('/master-organik', [MasterOrganikController::class, 'index'])->name('master-organik.index');
    Route::get('/manajemen-user/create', [MasterOrganikController::class, 'create'])->name('manajemen-user-create-view');
