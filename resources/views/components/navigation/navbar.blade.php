<div class="navbar bg-gray-50 px-12">
    <div class="flex-1">
        <a class="text-3xl font-bold text-teal-600">SiDokTer <span class="text-sm py-1 px-2 bg-green-200 rounded-xl">0.9.1</span><span class="text-sm py-1 px-2 bg-green-200 rounded-xl mx-2">Seperti Itu</span></a>
    </div>
    <div class="flex-none">
