...
<body class="bg-gray-100 flex items-center justify-center h-screen">
    ...
    <div class="bg-white shadow-md rounded-lg p-6 w-full max-w-sm">
        ...
        <p class="text-sm text-gray-500 text-center mb-6">Silakan masukkan email dan password Anda</p>
        <form action="{{route('validateUser')}}" method="POST" class="space-y-4">
            @csrf
            <div>
                <label for="nip_bps" class="block text-sm font-medium text-gray-600">Email</label>
